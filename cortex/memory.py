...
class Memory:
    ...
    def __init__(self, workspace_root, conversation_dir=None):
        ...
        self.memory_file = os.path.join(workspace_root, '.cortex_memory.json')
        # Conversation persists in gondola dir, not user's workspace
        conv_dir = conversation_dir or workspace_root
        self.conversation_file = os.path.join(conv_dir, '.cortex_conversation.json')
    ...
    def _default(self):
        return {
            ...
            "last_balance_vcu": 0.0,  # Cortex credit balance
