"""
Image Operations Mixin for Cortex AI
Provides AI image generation and editing tools using Cortex seedream-v4/seedream-v4-edit models.
"""
...
class ImageOpsMixin:
    ...
    def generate_image(self, prompt: str, filename: str = None, width: int = 1024, height: int = 1024) -> Dict:
        """
        Generate an image using Cortex seedream-v4 model.
        ...
        from cortex.api import get_api_key
        api_key = get_api_key()
        if not api_key:
            return {"success": False, "error": "Cortex API key not configured"}
        ...
        try:
            ...
            UI.step_detail(f"Calling Cortex API (seedream-v4)...")
            ...
            with httpx.Client(timeout=120.0) as client:
                ...
                # Cortex returns images as base64 in "images" array
    ...
    def edit_image(self, prompt: str, reference_image: str = "avatar.png", filename: str = None) -> Dict:
        """
        Edit/transform an image using Cortex image edit model. Defaults to avatar.png.
        ...
        try:
            ...
            UI.step_detail(f"Calling Cortex API ({edit_model})...")
            ...
            with httpx.Client(timeout=120.0) as client:
                ...
                # Handle response - Cortex returns binary (image/*) or JSON
